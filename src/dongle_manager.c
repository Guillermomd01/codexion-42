...
void	request_dongle(t_dongle *dongle, t_coder *coder)
{
	...
	// Comprobamos de forma segura si seguimos vivos antes de actuar
...
void	release_dongle(t_dongle *dongle, t_coder *coder)
{
	...
	//We wake everyone up because the next thread
	// might not be the one that needs to be woken up
	// can take may fail due to the cooldown
